    ...
    <form>
      ...
      <center>
        <button
          ...
          on:click={() => setToDefault()}>Reset Search</button
        >
        <button
          type="button"
          class="btn btn-primary"
          on:click={() => getSearchFromYelpAPI()}>Search Place</button
        >
      </center>
    </form>
  </div>
...
<div>
  <center>
    <p>
      The <strong>Advanced Search</strong> utilizes the Yelp API to find the search
      result that fits your taste.
    </p></center
  >
</div>
